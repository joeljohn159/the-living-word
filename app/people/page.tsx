...
export const metadata: Metadata = {
  ...
  description:
    "Explore over 100 biblical figures — patriarchs, prophets, kings, apostles, and more. Search and filter the complete directory of people in the King James Bible.",
  openGraph: {
    title: "People of the Bible | The Living Word",
    description:
      "Explore over 100 biblical figures — patriarchs, prophets, kings, apostles, and more.",
  },
};
